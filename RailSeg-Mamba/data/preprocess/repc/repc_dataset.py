...
class RepcDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        return_data = {
            "points":data,
            "labels":label,
            "voxel_coordinate":voxel_coordinate_all
        }
        return return_data
...
def build_dataloader(mode):
    if mode =="train":
        ...
        #sampler = None
        loader = DataLoader(dataset=dataset, batch_size=4,sampler=sampler,pin_memory=True,num_workers=4)
...
if __name__ == "__main__":
    class_name = ['void', 'tree', 'line', 'pole', 'building', 'rail', 'pathway', 'bar', 'hillside', 'tunnel',
                  'platform']
    traindata = RepcDataset(mode='train',centralization_flag=True)
    print(len(traindata))
    print(traindata[0])
    label_all = []
    ...
    unique_label,count = np.unique(label_all,return_counts=True)
    for index in range(11):
        print(f"class{class_name[index]} num= {count[index]}")
...
75759616
classvoid num= 16130
classtree num= 2676195
classline num= 391124
classpole num= 143195
classbuilding num= 35296
classrail num= 2452427
classpathway num= 29208296
classbar num= 2471789
classhillside num= 10973922
classtunnel num= 27388416
classplatform num= 2826

train
681803776
classvoid num= 147427
classtree num= 24020183
classline num= 3524379
classpole num= 1300916
classbuilding num= 323027
classrail num= 22049857
classpathway num= 262558528
classbar num= 22033449
classhillside num= 98849978
classtunnel num= 246975552
classplatform num= 20480

classvoid num= 163557
classtree num= 26,696,378
classline num= 3,915,503
classpole num= 1,444,111
classbuilding num= 358,323
classrail num= 24,502,284
classpathway num= 291,766,824
classbar num= 24,505,238
classhillside num= 109,823,900
classtunnel num= 274,363,968
classplatform num= 23,306
'''